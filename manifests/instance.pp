# @define tp::instance
#
# This define manages an instance of a application.
#
# @example instanceation (of any any supported app and OS):
#   tp::instance { $app: }
#
# @example instanceation of postfix
#   tp::instance { 'postfix': }
#
# @example instanceation and configuration via a custom hash of tp::conf
# resources used to manage configuration files
#   tp::instance { 'puppet':
#     conf_hash => hiera('tp::puppet::confs'),
#   }
#
# @example instanceation with custom settings
#   tp::instance { 'apache':
#     settings_hash => {
...
define tp::instance (
  ...
  } elseif $settings[package_name] == Array {
    $service_require = Package[$settings[package_name][0]]
  } else {
